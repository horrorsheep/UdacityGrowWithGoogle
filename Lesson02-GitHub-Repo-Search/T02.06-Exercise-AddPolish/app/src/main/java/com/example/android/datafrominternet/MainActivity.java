...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMessageErr = (TextView) findViewById(R.id.tv_error_message_display);
